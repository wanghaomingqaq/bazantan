...
if __name__ == '__main__':
    def mainwork():
        ...
        for i in range(num_comm):
            ...
            print(reward)
            eta = 100*(1 + 4*i/num_comm)
            true_reward  = (before_reward-reward)*eta
            true_reward = max(-10, min(true_reward, 10))  # 设置上下限制
            print("tr: ",true_reward)
            ddpg.replay_buffer.push(state,action,true_reward,next_state)
